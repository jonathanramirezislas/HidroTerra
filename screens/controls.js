...
class controls extends Component {
  ...
  componentDidMount() {
    this._interval = setInterval(() => {
      axios.get(baseUrl+'sensorsdata.php').then((res) => {
        const data = res.data;
        this.setState({ data });
    ...
    axios.get(baseUrl+'parameters.php').then((res) => {
      const data = res.data;
      this.setState({ data });
  ...
  handleSubmit = async () => {
    ...
    if (
      (typeof parseInt(this.state.tempMinValue) == "number") &
  ...
  handleValueChangeSpotlight = async (value) => {
    ...
    this.state.switchValue
      ? formData.append("spotlightValue", "0")
      : formData.append("spotlightValue", "1");
  ...
  render() {
    ...
    const dataArray = [
      {
        title: "Spotlight",
        content: "Spotlight Moon Night Black Light Moonlight 75 W Terrarium",
      },
      {
        title: "Water pump",
        content: "It can provide a flow of up to: 33.3ml / s",
      },
                    ...
                    <Body style={{ marginLeft: "-5%" }}>
                      ...
                      >
                        <Thumbnail
                          ...
                          source={{
                            uri:
                              "https://sciencebite.com/wp-content/uploads/2018/10/Temperature-Extremes.png",
                          }}
                        />
                      </ProgressCircle>
                    ...
                    <Body style={{ marginLeft: "-5%" }}>
                      ...
                      >
                        <Thumbnail
                          ...
                          source={{
                            uri:
                              "https://www.farmmanagement.pro/wp-content/uploads/2017/10/soil-moisture-620x330.jpg",
                          }}
                        />
                      </ProgressCircle>
                      <Text style={{ color: "white", textAlign: "center" }}>
                    ...
                    <Body>
                      ...
                      >
                        <Thumbnail
                          ...
                          source={{
                            uri:
                              "https://www.scienceabc.com/wp-content/uploads/2017/12/Humidity-water-drops-on-glass.jpg",
                          }}
                        />
                      </ProgressCircle>
                      <Text style={{ color: "white", textAlign: "center" }}>
            ...
            <Card>
              ...
              <CardItem style={{ alignItems: "center" }}>
                <TextInput
                  ...
                  onChangeText={(tempMinValue) =>
                    this.setState({ tempMinValue })
                  }
                  label="Minimum Value"
                ...
                <TextInput
                  ...
                  onChangeText={(tempMaxValue) =>
                    this.setState({ tempMaxValue })
                  }
                  label="Maximum Value"
                  keyboardType="numeric"
              ...
              <CardItem>
                <TextInput
                  ...
                  onChangeText={(soilMoistureMinValue) =>
                    this.setState({ soilMoistureMinValue })
                  }
                  label="Minimum Value"
                  keyboardType="numeric"
                  style={{ width: 150 }}
                ...
                <TextInput
                  ...
                  onChangeText={(soilMoistureMaxValue) =>
                    this.setState({ soilMoistureMaxValue })
                  }
                  label="Maximum Value"
                  keyboardType="numeric"
                  style={{ marginLeft: "5%", width: 150 }}
              ...
              <CardItem>
                <TextInput
                  ...
                  onChangeText={(humidityMinValue) =>
                    this.setState({ humidityMinValue })
                  }
                  label="Minimum Value"
                  keyboardType="numeric"
                  style={{ width: 150 }}
                ...
                <TextInput
                  ...
                  onChangeText={(humidityMaxValue) =>
                    this.setState({ humidityMaxValue })
                  }
                  label="Maximum Value"
                  keyboardType="numeric"
                  style={{ marginLeft: "5%", width: 150 }}
